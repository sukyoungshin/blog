  ...
  return (
    ...
    <Link href="/write">
      <a>
        <CardWrapper>
          <ImageWrapper>
            <Image src={'/cat.webp'} width={320} height={167} alt="profile" />
          </ImageWrapper>
          ...
          <ContentWrapper>
            ...
            <p>{tempContent}...</p>
            <p>
              <span>{tempDate}</span> <span>{tempNumberOfComments}</span>
            </p>
          </ContentWrapper>
          ...
          <TabMenuList>
            <TabMenu>
              <ul>
                <li>
                  <Image src={'/cat.webp'} width={24} height={24} style={{ borderRadius: '50%' }} alt="프로필사진" />
                </li>
                <li>
                  by <strong>{tempUserName}</strong>
                </li>
              </ul>
            </TabMenu>
...
const LikeButton = (): ReactElement => {
  return (
    <Button svgAndText={true} small={true} onClick={() => console.log('좋아요 버튼')}>
